      ...
      <div class="container logo-wrap">
        <div class="row pt-5">
          <div class="col-12 text-center">
            ...
            <h1 class="site-logo text-capitalize"><a href="{{action('User\IndexController@index')}}">Knowledge Home</a></h1>
          </div>
        </div>
      </div>
            ...
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown05">
                  ...
                  <a class="dropdown-item" href="{{action('User\CategorySessionController@index', ['id' => $row->categoryID])}}">{{$row->name}}</a>
                  @endforeach

        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><i class="icon-file-plus"></i> Add Category</h5>
                </div>

                <form action="{{action('Admin\Post\PostCategoryController@save')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
    ...
    <div id="ediModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{action('Admin\Post\PostCategoryController@edit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
